...
from .views import add_funeral_policy, funeral_policy_list, add_indlu_loan_data, indlu_data_list, smart_credit_data_list, add_smart_credit_data_list, FuneralPolicyList
