...
class IndluLoanData(models.Model):
    ...
    client_ref = models.CharField(max_length=250, )
    loan_ref_Id = models.CharField(max_length=250, )
    ...
    disbursement_month = models.CharField(max_length=250, )
    application_score = models.CharField(max_length=250, )
    risk_band = models.CharField(max_length=250, )
    ...
    last_payment_month = models.CharField(max_length=250, )
    gender = models.CharField(max_length=250, choices = gender_choices)
    employer = models.CharField(max_length=250)
    loan_amount = models.CharField(max_length=250,)
    int_rate = models.CharField(max_length=250,)
    loan_term = models.CharField(max_length=250, )
    remaining_term = models.CharField(max_length=250, )
    CD_move = models.CharField(max_length=250, )
